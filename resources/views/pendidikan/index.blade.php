...
@section('content')
    ...
    <div class="form-tambah d-flex flex-col justify-content-end align-items-center mb-3 gap-4 h-100">
        ...
        <x-modal id="exampleModal" title="Tambah Data Pendidikan" form-action="{{ route('pendidikan.store') }}" method="POST"
            submit-text="Simpan">
            <div class="mb-3">
                            ...
                            <div class="opsi d-flex justify-content-center align-items-center gap-2">
                                <div class="update">
                                    <button type="button" class="btn btn-warning btn-sm" data-bs-toggle="modal"
                                        data-bs-target="#pendidikan-{{ $item->id }}">
                                        <i class="fas fa-pen-to-square"></i>
                                        Edit
                                    </button>
                                    <x-modal id="pendidikan-{{ $item->id }}" title="Tambah Data Pendidikan"
                                        form-action="{{ route('pendidikan.update', $item->id) }}" method="PUT"
                                        submit-text="Update">
                                        <div class="mb-3">
                                            <label for="pendidikan" class="form-label">Pendidikan</label>
